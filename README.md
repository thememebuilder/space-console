...
2. Framework Preset: Vite. Build command: ite build (default). Output: dist/.
...
- [ ] Add basic pages: Home (hero, value prop), About, Contact
- [ ] Add Header/Footer and simple brand styling
- [ ] Configure ESLint + Prettier
- [ ] Set up GitHub repo and push initial code
- [ ] Connect repo to Vercel and deploy preview
- [ ] Configure domain space-console.com on Vercel and verify DNS
